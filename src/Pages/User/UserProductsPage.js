...
export default class UserProductsPage extends Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: true,
        ...
        <div className="row g-gs">
            ...
            <div className="card card-bordered product-card">
              <div className="product-thumb">
                <Link to={`/user/product/${product.productId}`}>
              ...
              <div className="card-inner text-center">
                ...
                <h5 className="product-title"><Link to={`/user/product/${product.productId}`}>{product.productName}</Link></h5>
                {
