...
export default class SellerRegistationPage extends Component {
  ...
  register() {
    ...
    if (!(/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test(this.refs.emailAddress.value))){
      errormessage = <div>{errormessage}<div>Email Address is not valid<br/></div></div>;
    }
    ...
    UsersDataService.create(data)
      ...
      .catch(error => {
        Toastr(
          "error",
          "There is problem registering the user "+error.response.data.message
        );
        ...
        <div className="nk-split nk-split-page nk-split-md">
          ...
          >
            <div className="slider-wrap w-100 w-max-550px p-3 p-sm-5 m-auto">
              ...
              >
                <h1 className="text-white">Create your own Smart Audit Account</h1>
